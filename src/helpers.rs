...
mod tests {
    ...
    fn test_normalize_filename() {
        assert_eq!(
            normalize_filename("./src/components/App.tsx"),
            "src/components/App.tsx"
        );
        assert_eq!(
            normalize_filename("/Users/dev/project/src/App.tsx"),
    ...
    fn test_generate_boundary_id() {
        ...
        assert_eq!(
            generate_boundary_id("components/MyComponent.tsx", 123),
            "components/MyComponent.tsx:123"
        );
    }
